var md5='a1d0c6e83f027327d8461063f4ac58a6'
window['url_form_'+md5]='https://aefassessoria.com,br'
window['redirect_url'+md5]='https://';var div='sh-crm-form-a1d0c6e83f027327d8461063f4ac58a6'
var form='<div class="input-container row" style="background-color: transparent;"><div class="col-12"><input title="name" class="input-form input-field outlined-input" type="text" name="name" placeholder="Nome e sobrenome" id="name_input_1690388757628846131" style="background-color: white; outline: none; border-color: rgb(191, 191, 191);"></div><div class="col-12"><input title="email" class="input-form input-field outlined-input" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" name="email" placeholder="Email *" id="email_input_1690388757960586903" style="background-color: white; outline: none; border-color: rgb(191, 191, 191);" required="true"></div><div class="col-12"><input title="phone" class="input-form input-field outlined-input" type="tel" pattern="[0-9]{2} [0-9]{5}-[0-9]{4}" name="phone" placeholder="Whatsapp (Com ddd) *" id="phone_input_1690388758256262187" style="background-color: white; outline: none; border-color: rgb(191, 191, 191);" required="true"></div><input type="hidden" name="form_response_id" value=""><div class="col-12" style="margin-top: 10px; text-align: center;"><input title="Enviar" class="input-form ok-button okbutton-standard ok-button-center a1d0c6e83f027327d8461063f4ac58a6" type="submit" name="okbutton" value="Falar com especialista" id="okbutton_input" style="color: rgb(255, 255, 255); border-color: rgb(3, 161, 140); background-color: rgb(3, 163, 142);"></div></div>'
var cssId='forms.css'
