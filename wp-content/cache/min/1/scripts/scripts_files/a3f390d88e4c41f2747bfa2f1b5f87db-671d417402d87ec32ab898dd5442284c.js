var md5='a3f390d88e4c41f2747bfa2f1b5f87db'
window['url_form_'+md5]='https://aefassessoria.com,br'
window['redirect_url'+md5]='https://www.aefassessoria.com.br/apresentacao-sistema-online/';var div='sh-crm-form-a3f390d88e4c41f2747bfa2f1b5f87db'
var form='<div class="q-card__section q-card__section--vert input-container row" style="display: flex; flex-wrap: wrap; justify-content: space-between; background-color: rgb(5, 83, 252);"><input type="hidden" name="form_response_id" value=""><div class="column-size" style="width: 100%;"><input title="name" class="input-form input-field outlined-input" type="text" name="name" placeholder="Qual seu nome completo?" id="name_input_1696980064894478255" style="background-color: white; outline: none; max-width: 100%; box-sizing: border-box; font-weight: 300; border-color: rgb(219, 219, 219);" required="true"></div><div class="column-size" style="width: 100%;"><input title="email" class="input-form input-field outlined-input" type="email" name="email" placeholder="Qual email que você mais utiliza? de preferência o profissional *" id="email_input_1696980065966329574" style="background-color: white; outline: none; max-width: 100%; box-sizing: border-box; font-weight: 300; border-color: rgb(219, 219, 219);" required="true"></div><div class="column-size" style="width: 100%;"><input title="phone" class="input-form input-field outlined-input" type="tel" name="phone" placeholder="Whatsapp com DDD *" id="phone_input_1696980067276625601" style="background-color: white; outline: none; max-width: 100%; box-sizing: border-box; font-weight: 300; border-color: rgb(219, 219, 219);" required="true"></div><div class="column-size" style="width: 100%;"><input title="Texto Personalizado" class="input-form input-field outlined-input" type="text" name="Quantas pessoas irão utilizar o sistema?" placeholder="Quantas pessoas irão utilizar o sistema?" id="text_input_1696980074084352017" style="background-color: white; outline: none; max-width: 100%; box-sizing: border-box; font-weight: 300; border-color: rgb(219, 219, 219);" required="true"></div><div class="col-12" style="margin-top: 10px; width: 100%; text-align: center;"><input title="Enviar" class="input-form ok-button okbutton-standard ok-button-center a3f390d88e4c41f2747bfa2f1b5f87db" type="submit" name="okbutton" value="Trocar de Contador" id="okbutton_input" style="background-color: rgb(3, 163, 142); border-color: rgb(3, 161, 140); color: rgb(255, 255, 255); font-weight: 300;"></div></div>'
var cssId='forms.css'
