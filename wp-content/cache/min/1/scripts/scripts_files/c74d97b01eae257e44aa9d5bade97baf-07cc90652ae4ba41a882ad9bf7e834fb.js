var md5='c74d97b01eae257e44aa9d5bade97baf'
window['url_form_'+md5]='https://aefassessoria.com,br'
window['redirect_url'+md5]='https://www.aefassessoria.com.br/planos/';var div='sh-crm-form-c74d97b01eae257e44aa9d5bade97baf'
var form='<div class="input-container row" style="background-color: transparent;"><div class="col-12"><input title="Nome completo" class="input-form input-field outlined-input" type="text" name="name" placeholder="Nome Completo *" id="name_input_1681947997912243579" required="true" style="background-color: white; outline: none; border-color: rgb(237, 237, 237); color: rgb(0, 0, 0);"></div><div class="col-12"><input title="Email" class="input-form input-field outlined-input" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" name="email" placeholder="Email *" id="email_input_1681947999618153049" required="true" style="background-color: white; outline: none; border-color: rgb(237, 237, 237); color: rgb(0, 0, 0);"></div><div class="col-12"><input title="Número de Telefone" class="input-form input-field standard-input outlined-input" type="tel" pattern="[0-9]{2} [0-9]{5}-[0-9]{4}" name="phone" placeholder="Número de Telefone (Com ddd) *" id="phone_input_1682706893200990095" style="border-color: rgb(237, 237, 237); color: rgb(0, 0, 0); background-color: white; outline: none;" required="true"></div><input type="hidden" name="form_response_id" value=""><div class="col-12" style="margin-top: 10px; text-align: center;"><input title="Enviar" class="input-form ok-button okbutton-standard ok-button-center c74d97b01eae257e44aa9d5bade97baf" type="submit" name="okbutton" value="Iniciar conversa" id="okbutton_input" style="margin-left: 0px; border-color: rgb(22, 186, 148); background-color: rgb(22, 186, 148); color: rgb(255, 255, 255);"></div></div>'
var cssId='forms.css'
