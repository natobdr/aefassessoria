var md5='3c59dc048e8850243be8079a5c74d079'
window['url_form_'+md5]='https://aefassessoria.com,br'
window['redirect_url'+md5]='https://';var div='sh-crm-form-3c59dc048e8850243be8079a5c74d079'
var form='<div class="input-container row" style="background-color: transparent;"><div class="col-12"><input title="name" class="input-form input-field standard-input" type="text" name="name" placeholder="Nome e Sobrenome *" id="name_input_1684514364502848311" style="background-color: white; outline: none;" required="true"></div><div class="col-12"><input title="email" class="input-form input-field standard-input" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" name="email" placeholder="Email *" id="email_input_1684514368969126900" style="background-color: white; outline: none;" required="true"></div><div class="col-12"><input title="phone" class="input-form input-field standard-input" type="tel" pattern="[0-9]{2} [0-9]{5}-[0-9]{4}" name="phone" placeholder="Whatsapp (Com ddd) *" id="phone_input_1684514371390191827" style="background-color: white; outline: none;" required="true"></div><input type="hidden" name="form_response_id" value=""><div class="col-12" style="margin-top: 10px; text-align: center;"><input title="Enviar" class="input-form ok-button okbutton-standard ok-button-center 3c59dc048e8850243be8079a5c74d079" type="submit" name="okbutton" value="Enviar Agora!" id="okbutton_input" style="margin-left: 0px; background-color: rgb(23, 207, 164); border-color: rgb(23, 207, 164); color: rgb(255, 255, 255);"></div></div>'
var cssId='forms.css'
